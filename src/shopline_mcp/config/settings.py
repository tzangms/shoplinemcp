...
ENDPOINTS = {
    ...
    "order_action_logs": f"/{API_VERSION}/orders/{{order_id}}/action_logs",
    ...
    "customer_member_points": f"/{API_VERSION}/customers/{{customer_id}}/member_points",
    ...
    "customer_member_points_update": f"/{API_VERSION}/customers/{{customer_id}}/member_points",

    # === Customer Groups ===
    "customer_groups": f"/{API_VERSION}/customer_groups",
    "customer_groups_search": f"/{API_VERSION}/customer_groups/search",
